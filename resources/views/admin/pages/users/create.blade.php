        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="email"
                      class="form-control" value="{{ old('email') }}"  name="email" id="email"  placeholder="Email" required>
                      @error('email')
                          <small  class="form-text text-danger">{{ $message }}</small>
                      @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel"
                      class="form-control"  value="{{ old('mobile') }}"  name="mobile" id="mobile" minlength="10" maxlength="10" placeholder="Mobile No.">
                      @error('mobile')
                          <small  class="form-text text-danger">{{ $message }}</small>
                      @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password"
                      class="form-control" name="password" id="password" minlength="8" placeholder="Password" required>
                      @error('password')
                          <small  class="form-text text-danger">{{ $message }}</small>
                      @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password"
                      class="form-control" name="password_confirmation" id="re_password" minlength="8" placeholder="Password Confirmation" required>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="number"
                    class="form-control" value="{{ old('rate') }}" name="rate" id="rate" placeholder="Rate" min="0">
                    @error('rate')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('latitude') }}" class="form-control" name="latitude" id="lat"
                                    >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('longitude') }}" class="form-control" name="longitude" id="long"
                                    >
                            </div>
                        </div>
                    </div>
